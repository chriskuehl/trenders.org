      ...
      <div class="column3">
        ...
        <div id="chartBack">
          ...
          <script>
			...
			return "${createLink(mapping: "graphProxy")}?width=" + chartWidth + "&height=" + chartHeight + "&symbol=" + symbol + "&duration=" + days + "&headertype=none";
            }
          </script>
        </div>
