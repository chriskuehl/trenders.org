...
<html>
  ...
  <body>
    ...
    -->
    <div id="flag">
      <p id="flagIntroText"><strong>trenders.org</strong> is an educational site where you can learn about personal investing and personal finance as part of a class.</p>
    ...
    <div class="column3">
	  ...
	  <div id="chart" style="background-image: url('${g.createLink(mapping: "graphProxy", params: [width: chartWidth, height: chartHeight, symbol: ".DJI", duration: 5, headertype: "none"])}'); width: ${chartWidth}px; height: ${chartHeight}px;">
      ...
      <g:set var="chartWidth" value="329" />
      <g:set var="chartHeight" value="90" />
	  <div id="chart" style="background-image: url('${g.createLink(mapping: "graphProxy", params: [width: chartWidth, height: chartHeight, symbol: ".SPX", duration: 5, headertype: "none"])}'); width: ${chartWidth}px; height: ${chartHeight}px;">
        <p>Chart powered by Reuters.</p>
      </div>
